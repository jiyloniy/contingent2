...
django.setup()
from user.models import Group, Faculty, Budjet, Shartnoma, Organization, Yonalish, Guruh, User
    ...
    for k in kurs:
        ...
        for f in faculty:
            ...
            for y in yonalish:
                ...
                y_full_jami = y.yonalishguruh.filter(org=org, kurs=k['kurs']).aggregate(Sum('budjet__jami'),
                                                                                        Sum('budjet__harbiy'),
                                                                                        Sum('budjet__xotin_qiz'),
                                                                                        Sum('shartnoma__jami'),
                                                                                        Sum('shartnoma__harbiy'),
                                                                                        Sum('shartnoma__xotin_qiz'))
                ...
                set_cell_properties(ws.cell(row=row, column=6),
                                    (y_full_jami['budjet__xotin_qiz__sum'] or 0) + (
                                                y_full_jami['shartnoma__xotin_qiz__sum'] or 0),
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                ...
                set_cell_properties(ws.cell(row=row, column=7),
                                    (y_full_jami['budjet__harbiy__sum'] or 0) + (
                                                y_full_jami['shartnoma__harbiy__sum'] or 0),
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                ...
                set_cell_properties(ws.cell(row=row, column=10), akademik_sum['akademik__sum'],
                                    ...
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           ...
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=11), y_full_jami['budjet__jami__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=12), y_full_jami['budjet__harbiy__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=13), y_full_jami['budjet__xotin_qiz__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=14), y_full_jami['shartnoma__jami__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=15), y_full_jami['shartnoma__harbiy__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=16), y_full_jami['shartnoma__xotin_qiz__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
            ...
            f_full_jami = Guruh.objects.filter(
                org=org,
                yonalish__faculty=f,
                kurs=k['kurs']).aggregate(Sum('budjet__jami'),
                                          Sum('budjet__harbiy'),
                                          Sum('budjet__xotin_qiz'),
                                          Sum('shartnoma__jami'),
                                          Sum('shartnoma__harbiy'),
            ...
            jami = (f_full_jami['budjet__jami__sum'] or 0) + (f_full_jami['shartnoma__jami__sum'] or 0)
            shundan_qizlar = (f_full_jami['budjet__xotin_qiz__sum'] or 0) + (
                    f_full_jami['shartnoma__xotin_qiz__sum'] or 0)
            harbiy = (f_full_jami['budjet__harbiy__sum'] or 0) + (f_full_jami['shartnoma__harbiy__sum'] or 0)
            ...
            f_name = ''.join(re.findall(r'\b\w', f_name)).upper()
            f_name2 = ''
            ...
            if jami != 0:
                ...
                set_cell_properties(ws.cell(row=row, column=10), akademik_tatil,
                                    ...
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           ...
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=11), f_full_jami['budjet__jami__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=12), f_full_jami['budjet__harbiy__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=13), f_full_jami['budjet__xotin_qiz__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=14), f_full_jami['shartnoma__jami__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=15), f_full_jami['shartnoma__harbiy__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           top=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           bottom=Side(border_style=BORDER_STYLE, color=BORDER_COLOR)))
                set_cell_properties(ws.cell(row=row, column=16), f_full_jami['shartnoma__xotin_qiz__sum'],
                                    Alignment(horizontal='center', vertical='center'),
                                    Font(name=FONT_NAME, size=FONT_SIZE, bold=True, italic=False, color=FONT_COLOR),
                                    Border(left=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
                                           right=Side(border_style=BORDER_STYLE, color=BORDER_COLOR),
...
# faculty = Faculty.objects.filter(org=org, org__guruh__kurs=k['kurs']).distinct()
# # for f in faculty:
# #     yonalish = Yonalish.objects.filter(faculty=f, yonalishguruh__kurs=k['kurs']).distinct()
# #     for y in yonalish:
# #         guruh = Guruh.objects.filter(yonalish=y, org=org, kurs=k['kurs']).distinct()
